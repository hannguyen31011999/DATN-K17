		...
		@foreach($item as $carts)
			...
			<a class="pull-left" href="#"><img src="user/image/product/{{$carts->options['img']}}" alt=""></a>
				<div class="media-body">
					...
					<span class="cart-item-amount">{{$carts->qty}}*<span>{{thousandSeperator($carts->price)}}đ</span></span>
			...
			<a class="pull-left" href="#"><img src="user/image/product/{{$carts->options['img']}}" alt=""></a>
				<div class="media-body">
					<span class="cart-item-title">{{$carts->name}}</span>
					<span class="cart-item-amount">{{$carts->qty}}*<span>{{thousandSeperator($carts->option->promotion_price)}}</span></span>
				</div>
			@endif
		@endforeach
	</div>
...
<div class="cart-caption">
	<div class="cart-total text-right">Tổng tiền: <span class="cart-total-value">{{Cart::subtotal(0,'.','.')}}đ</span></div>
