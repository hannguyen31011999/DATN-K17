			...
			<div class="your-order-item">
	      	...
	      	@if(!empty($discount))
		      	...
		      	<div class="your-order-item">
					...
					<div class="pull-right"><h5 style="font-size: 15px;">{{thousandSeperator(Session::get('cart')->totalPrice)}}đ</h5></div>
				</div>
				@else
				<div class="your-order-item">
					<div class="pull-left"><p class="your-order-f18">Tổng tiền:</p></div>
					<div class="pull-right"><h5 style="font-size: 20px;">{{thousandSeperator(Session::get('cart')->totalPrice+50000)}}đ</h5></div>
				</div>
				@endif
	      	@else
		      	<div class="your-order-item">
