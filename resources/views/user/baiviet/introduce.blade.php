                ...
                <div class="history-slider">
                    ...
                    <div class="history-slides">
                        <div> 
                            <div class="row">
                            <div class="col-sm-5">
                                <img src="{{asset('admin/image/daubep/duong-huy-khai-54123.jpg')}}" alt="">
                            </div>
                            <div class="col-sm-7">
                        ...
                        <div> 
                            <div class="row">
                            <div class="col-sm-5">
                                <img src="{{asset('admin/image/daubep/duong-huy-khai-54126.jpg')}}" alt="">
                            </div>
                            <div class="col-sm-7">
                        ...
                        <div> 
                            <div class="row">
                            <div class="col-sm-5">
                                <img src="{{asset('admin/image/daubep/duong-huy-khai-54125.jpg')}}" alt="">
                            </div>
                            <div class="col-sm-7">
                        ...
                        <div> 
                            <div class="row">
                            <div class="col-sm-5">
                                <img src="{{asset('admin/image/daubep/hai-mai-14-3648-x-2432-0001-read-only-1455402320.jpg')}}" alt="">
                            </div>
                            <div class="col-sm-7">
                        ...
                        <div> 
                            <div class="row">
                            <div class="col-sm-5">
                                <img src="{{asset('admin/image/daubep/duong-huy-khai-54118.jpg')}}" alt="">
                            </div>
                            <div class="col-sm-7">
                        ...
                        <div> 
                            <div class="row">
                            <div class="col-sm-5">
                                <img src="{{asset('admin/image/daubep/phan-ton-tinh-hai-396033.jpg')}}" alt="">
                            </div>
                            <div class="col-sm-7">
                        ...
                        <div> 
                            <div class="row">
                            <div class="col-sm-5">
                                <img src="{{asset('admin/image/daubep/christine-ha-396035.jpg')}}" alt="">
                            </div>
                            <div class="col-sm-7">
