...
<form action="" method="POST" id="submit-doanhthu">
    @csrf
    <select class="custom-select" id="doanh-thu" name="list-order" style="width:145px;"></select>
    <select class="custom-select" id="doanh-thu-month" name="list-order" style="width:145px; margin-left: 15px;">
        <option>
            Tháng
        </option>
    </select>
